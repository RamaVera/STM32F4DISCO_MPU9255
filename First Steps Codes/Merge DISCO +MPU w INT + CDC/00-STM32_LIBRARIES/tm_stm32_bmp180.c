...
#ifndef BMP180_USE_ALTITUDE
#define BMP180_USE_ALTITUDE        1
#endif
...
TM_BMP180_Result_t TM_BMP180_Init(TM_BMP180_t* BMP180_Data) {
	...
	if (TM_I2C_IsDeviceConnected(BMP180_I2C, BMP180_I2C_ADDRESS) != TM_I2C_Result_Ok) {
  ...
  if (TM_I2C_ReadMulti(BMP180_I2C, BMP180_I2C_ADDRESS, BMP180_REGISTER_EEPROM, data, 22) 
      == TM_I2C_Result_Ok
     ) 
  {
...
TM_BMP180_Result_t TM_BMP180_StartTemperature(TM_BMP180_t* BMP180_Data) {
	...
	/* Send to device */
  if (TM_I2C_Write(BMP180_I2C, BMP180_I2C_ADDRESS
                , BMP180_REGISTER_CONTROL, BMP180_COMMAND_TEMPERATURE) 
      == TM_I2C_Result_Ok )
	/* Set minimum delay */
	BMP180_Data->Delay = BMP180_TEMPERATURE_DELAY;
  else
    return TM_BMP180_Result_Fail;
	/* Return OK */
	return TM_BMP180_Result_Ok;
}
...
TM_BMP180_Result_t TM_BMP180_ReadTemperature(TM_BMP180_t* BMP180_Data) {
  ...
  if ( TM_I2C_ReadMulti(BMP180_I2C, BMP180_I2C_ADDRESS, BMP180_REGISTER_RESULT, data, 2) 
      == TM_I2C_Result_Ok)
  {
...
TM_BMP180_Result_t TM_BMP180_StartPressure(TM_BMP180_t* BMP180_Data, TM_BMP180_Oversampling_t Oversampling) {
	...
	/* Send to device */
	if (TM_I2C_Write(BMP180_I2C, BMP180_I2C_ADDRESS, BMP180_REGISTER_CONTROL, command)
      == TM_I2C_Result_Ok)
...
TM_BMP180_Result_t TM_BMP180_ReadPressure(TM_BMP180_t* BMP180_Data) {
	...
	/* Read multi bytes from I2C */
	if (TM_I2C_ReadMulti(BMP180_I2C, BMP180_I2C_ADDRESS, BMP180_REGISTER_RESULT, data, 3)
      == TM_I2C_Result_Ok)
  {
