...
@endverbatim
 *
 * \par PAW library dependence
 *
 * calculation of Altitude and PressureAtSeaLevel require paw library. If you not need one parameters, open defines.h file and edit lines below:
 * 
@verbatim
//Select PAW library dependence
#define BMP180_USE_ALTITUDE        0
@endverbatim
 *
 * \par Changelog
 *
