 ...
 *	@link		http://stm32f4-discovery.net/2014/09/library-35-lis302dl-or-lis3dsh-accelerometer
 *	@version 	v1.0
 *	@ide		Keil uVision
 *	@license	GNU GPL v3
 *	
...
/* CS pin settings */
#define LIS302DL_LIS3DSH_CS_LOW				TM_GPIO_SetPinLow(LIS302DL_LIS3DSH_CS_PORT, LIS302DL_LIS3DSH_CS_PIN)
#define LIS302DL_LIS3DSH_CS_HIGH			TM_GPIO_SetPinHigh(LIS302DL_LIS3DSH_CS_PORT, LIS302DL_LIS3DSH_CS_PIN)
